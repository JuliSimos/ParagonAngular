...
export class LibrosDataService {
  libros: Libros[] = [
    {
      portada:
        'https://raw.githubusercontent.com/JuliSimos/ParagonAngular/main/src/assets/img/miPortada.jpg',
      titulo: 'Mi portada',
      genero: 'Habilidades',
      descripcion:
        'Lorem ipsum dolor sit amet consectetur adipisicing elit. Ad sed aut distinctio cupiditate.',
      guardado: true,
    },
    {
      portada:
        'https://raw.githubusercontent.com/JuliSimos/ParagonAngular/main/src/assets/img/filosofiaParaUnaVidaUnica.jpg',
    ...
    {
      portada:
        'https://raw.githubusercontent.com/JuliSimos/ParagonAngular/main/src/assets/img/Almendra.jpg',
      titulo: 'Almendra',
      genero: 'Ficción',
      descripcion:
        'Lorem ipsum dolor sit amet consectetur adipisicing elit. Ad sed aut distinctio cupiditate.',
    ...
    {
      portada:
        'https://raw.githubusercontent.com/JuliSimos/ParagonAngular/main/src/assets/img/laUnicaEnLaTierra.jpg',
    ...
    {
      portada:
        'https://raw.githubusercontent.com/JuliSimos/ParagonAngular/main/src/assets/img/losChicosdeLaNIckel.jpg',
  ...
  isGuardado(libro: Libros): boolean {
    for (let i = 0; i < this._librosGuardados.length; i++) {
      if (this._librosGuardados[i] == libro) return true;
    }
    return false;
  }
  ...
  quitarLibroGuardado(libro: Libros): void {
    for (let i = 0; i < this._librosGuardados.length; i++) {
      if (this._librosGuardados[i] == libro) this._librosGuardados.splice(i);
    }
  }
}
